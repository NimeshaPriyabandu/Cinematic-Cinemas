...
<div class="navbar-container">
	<nav class="navbar">
        <ul class="navbar-menu">
            <li><a class="active" href="action.php">Action</a></li>
...
<div id="home-section-1" class="trailers-section"><br>
    <h1 class="section-title">Now showing | Action</h1>
