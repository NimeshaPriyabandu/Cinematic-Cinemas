...
<body>
    ...
    <nav class="navbar">
        <ul class="navbar-menu">
            ...
            <li><a class="active" href="comedy.php">Comedy</a></li>  
    ...
    <div id="home-section-1" class="trailers-section">
        <br>
        <h1 class="section-title">Now showing | Comedy</h1>
        <h3>Click on it For Youtube Trailer</h3>
        <div class="trailers-grid">
        <div class="trailers-grid-item">
                <img src="img/comedy-1.jpg" alt="">
                <div class="trailer-item-info">
                    <h3>The Lego Movie</h3>
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/comedy-2.jpg" alt="">
                <div class="trailer-item-info">
                    <h3>Karmat Bytmrmt</h3>   
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/comedy-3.jpg" alt="">
                <div class="trailer-item-info">
                    <h3>Secret Men Club</h3>  
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/comedy-4.jpg" alt="">
                <div class="trailer-item-info">
                    <h3>VICE</h3>
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/comedy-5.jpg" alt="">
                <div class="trailer-item-info">
                    <h3>The Vanishing</h3>    
                </div>
            </div>
